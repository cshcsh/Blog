		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					<li><a href="${pageContext.request.contextPath}/blogInfo.html"><font color="black"><strong>博客信息</strong></font></a></li>
					...
					<!--<li><a href="#"><font color="black"><strong style="color: red">Java毕业设计定制</strong></font></a></li>-->
				</ul>
