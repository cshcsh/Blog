...
<title>Java博客系统后台管理页面 - Powered By java5200</title>
...
<body class="easyui-layout">
	<div region="north" style="height: 78px; background-color: #E0ECFF">
		<table style="padding: 5px" width="100%">
			<tr>
				<td width="50%"><font size="7"><strong>Java博客管理系统</strong></font>
				</td>
				
				<td valign="bottom" align="right" width="50%"><font size="3">&nbsp;&nbsp;<strong>欢迎：</strong><font
						color="red">${currentUser.userName }</font></font></td>
			</tr>
		</table>
	</div>
	<div region="center">
	...
	<div region="south" style="height: 25px; padding: 5px" align="center">
		Copyright © 2017-2018 Java项目分享网 版权所有</div>
